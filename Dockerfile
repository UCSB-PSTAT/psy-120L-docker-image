...
RUN R -e "install.packages(c('shiny','usethis','covr','httr','roxygen2','rversions','devtools','igraph','imager','patchwork','littler', 'docopt','curl','httr','WDI', 'faraway', 'boot', 'car', 'pscl', 'vcd', 'stargazer', 'effsize', 'Rmisc', 'psych', 'afex', 'tidyverse', 'Rmisc', 'afex'), repos = 'https://cloud.r-project.org/', Ncpus = parallel::detectCores())"
