            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"psych\");library(\"afex\");library(\"Hmisc\");library(\"emmeans\");library(\"tidyverse\");library(\"ggplot\");library(\"lsr\");library(\"svglite\")"'
